...
>
> > [!info]+ **Rumus**
> > Untuk $X \sim \text{Poisson}(\lambda)$: $P(X = 0) = e^{-\lambda}$, $\text{Var}(X) = \lambda$.
> > Di sini $\lambda_1$ dan $\lambda_2$ adalah parameter Poisson untuk kendaraan dan kebakaran (bukan tingkat signifikansi).
>
> **Diketahui:**
> - Klaim kendaraan $\sim \text{Poisson}(\lambda_1)$, klaim kebakaran $\sim \text{Poisson}(\lambda_2)$
> - $P(\text{klaim kendaraan} = 0) = \frac{3}{2} \cdot P(\text{klaim kebakaran} = 0)$
...
> [!summary]+ **Jawaban No. 10** **$x = 10{.}800$ (e)**
>
> | Field | Isi |
> |-------|-----|
> | **Topik CF2** | Topik 2 — Variabel Acak Univariat |
...
> [!summary]+ **Jawaban No. 11** **$\frac{7}{16}$ (a)**
>
> | Field | Isi |
> |-------|-----|
...
>
> > [!info]+ **Rumus**
> > Distribusi bersyarat: $p_{X|Y}(x \mid y) = \frac{p(x,y)}{p_Y(y)}$
> > Variansi bersyarat: $\text{Var}(X \mid Y = y) = E[X^2 \mid Y=y] - (E[X \mid Y=y])^2$
> >
> > "Banyaknya ban tidak layak pakai dengan satu ban belakang tidak layak pakai" berarti: $X \mid Y=1$.
>
> **Diketahui:**
> - $p(x, y) = \frac{(6-x)(3-y)}{58(1+|x+y|)}$ untuk $x \in \{0,1,2\}$, $y \in \{0,1,2\}$
...
> [!summary]+ **Jawaban No. 12** **$(17{,}3;\; 22{,}7)$ (d)**
>
> | Field | Isi |
> |-------|-----|
> | **Topik CF2** | Topik 2 — Variabel Acak Univariat |
...
> [!summary]+ **Jawaban No. 15** **Modus $= 1$ (a)**
>
> | Field | Isi |
> |-------|-----|
> | **Topik CF2** | Topik 2 — Variabel Acak Univariat |
...
> [!summary]+ **Jawaban No. 17** **opsi (a) $\frac{4-4c}{0{,}2^3}$**
>
> | Field | Isi |
> |-------|-----|
> | **Topik CF2** | Topik 2 — Variabel Acak Univariat |
...
> [!summary]+ **Jawaban No. 19** **$a = \frac{5}{3}$ (c)**
>
> | Field | Isi |
> |-------|-----|
> | **Topik CF2** | Topik 3 — Variabel Acak Multivariat |
...
> [!summary]+ **Jawaban No. 23** **$0{,}0197$ (c)**
>
> | Field | Isi |
> |-------|-----|
